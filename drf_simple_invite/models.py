...
class InvitationToken(models.Model):
    ...
    user = models.ForeignKey(AUTH_USER_MODEL, related_name='invitation_tokes',on_delete=models.CASCADE, verbose_name=_("The User which is associated to this invitation token"))
